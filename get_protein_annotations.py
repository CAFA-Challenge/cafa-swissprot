...
def get_experimental_growth(protein_list_filepath:str, sprot_filepath:str):
    pass
...
if __name__ == "__main__":
    ...
    def get_proteins_under_annotation_threshold(
            ...
            max_annotations: int = 3,
            namespace_filter: Optional[Iterable] = NAMESPACES,
            allowed_evidence_codes: Optional[
                Iterable] = EXPERIMENTAL_EVIDENCE_CODES,
    )
    '''

    sp_filepath = "/home/scott/virtualenvs/cafa_swissprot/code/uniprot/2019_01/uniprot_sprot.dat"
    taxon_id = 9606

    test = get_proteins_under_annotation_threshold(sp_filepath, taxon_id, 2, namespace_filter=("CCO",))

    for protein, go_terms in test:
        print(protein, go_terms)
